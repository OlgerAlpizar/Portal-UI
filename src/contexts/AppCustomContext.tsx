...
export const AppCustomContext = createContext<AppCustomContextProps | null>(
  null
)

const AppCustomContextProvider: FC<AppCustomContextPropsProviderProps> = (
  props: AppCustomContextPropsProviderProps
) => {
